...
def test_authority_cli_writes_kicad_and_authority_bundle(
    ...
    monkeypatch.setattr(cli_module, "run_kicad_erc", fake_erc, raising=False)
    monkeypatch.setattr(cli_module, "export_kicad_spice_netlist", fake_spice_export, raising=False)
    monkeypatch.setattr(
        cli_module,
    ...
    monkeypatch.setattr(cli_module, "run_ngspice_simulation", fail_fallback)
...
def test_authority_cli_truthfully_marks_pcbs_fallback_when_kicad_spice_fails(
    ...
    monkeypatch.setattr(cli_module, "run_kicad_erc", fake_erc, raising=False)
    monkeypatch.setattr(cli_module, "export_kicad_spice_netlist", fake_spice_export, raising=False)
    monkeypatch.setattr(cli_module, "run_ngspice_netlist_file", fail_kicad_netlist, raising=False)
    monkeypatch.setattr(cli_module, "run_ngspice_simulation", fake_pcbs_fallback)
