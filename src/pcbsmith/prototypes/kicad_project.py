"""Prototype-only KiCad project skeleton retained for research replay."""
...
def render_kicad_board_file(
    ...
    *,
    ...
    outline_end_mm = (
        ("50 35" if board_body_items else "100 80")
        if outline_end_mm is None
        else outline_end_mm
    )
