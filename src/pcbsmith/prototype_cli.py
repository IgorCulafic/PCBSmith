"""Preserved prototype command surface from the GUI/catalog lineage.

The production command entry point remains :mod:`pcbsmith.cli`. It delegates
only commands unique to this earlier research surface into this module.
"""
