...
def _render_schematic(circuit: CircuitObject, project_name: str) -> str:
    ...
    wires = (
        # VIN rail with CIN tap, ending at the regulator VIN pin tip.
        _wire((25.4, 50.8), (35.56, 50.8)),
        _wire((35.56, 50.8), (43.18, 50.8)),
        ...
        # Output rail with COUT and feedback divider taps.
        _wire((83.82, 50.8), (91.44, 50.8)),
        _wire((91.44, 50.8), (99.06, 50.8)),
        _wire((99.06, 50.8), (109.22, 50.8)),
        ...
        _wire((35.56, 76.2), (41.91, 76.2)),
        _wire((41.91, 76.2), (55.88, 76.2)),
        _wire((55.88, 76.2), (63.5, 76.2)),
        _wire((63.5, 76.2), (91.44, 76.2)),
