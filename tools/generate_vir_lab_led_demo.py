...
def _silkscreen_items() -> list[str]:
    return [
        ...
        _text("0603 LEDs, 680R per LED", 180, 106, 1.2, "F.SilkS"),
        _text("VIR", 382, 84, 4.0, "F.SilkS"),
        _text("LAB", 382, 93, 4.0, "F.SilkS"),
        _gr_rect(366, 74, 412, 104, "F.SilkS"),
    ]
